    ...
    return (
        <div data-aos="fade-up" className=" w-[90vw] max-w-[1240px] mx-auto  max-h-[2150px]  ">
            ...
            <div  className="   grid grid-rows-3 grid-cols-2 gap-[40px] pt-[40px] max-lg:flex max-lg:flex-col max-lg:items-center ">
                ...
                <div  className=" w-full h-[310px] flex gap-[5vw] bg-[rgb(243,243,243)] rounded-[45px]  border-[1px] border-b-6 p-[50px]   max-sm:h-[220px] max-sm:p-[20px] max-sm:rounded-[30px] transition-all ease-in-out duration-300 hover:scale-105">
                ...
                <div className="w-full h-[310px] flex gap-[4vw] bg-[rgb(243,243,243)] rounded-[45px]  border-[1px] border-b-6 p-[50px] max-sm:h-[220px] max-sm:p-[20px] max-sm:rounded-[30px] transition-all ease-in-out duration-300 hover:scale-105">
                    <div className=" w-[400px]">
                ...
                <div  className="w-full flex gap-[5vw] h-[310px] bg-[rgb(243,243,243)] rounded-[45px]  border-[1px] border-b-6 p-[50px]  max-sm:h-[220px] max-sm:p-[20px] max-sm:rounded-[30px] transition-all ease-in-out duration-300 hover:scale-105">
                    <div className=" w-[400px]">
