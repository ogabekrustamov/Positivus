...
const SearchRanking = () => {
    ...
    return (
            ...
            <div data-aos="fade-up" className="bg-white flex  w-[90vw] max-w-[1240px] max-h-[850px] max-sm:h-[880px] border-b-[6px] border-[1px] border-black p-[60px] gap-[30px] rounded-[45px]  mt-[60px]  max-lg:flex-col  max-sm:p-[40px]  ">
