...
const SearchRanking = () => {
    ...
    return (
        <div className="bg-white flex  w-[90vw] max-w-[1240px] max-h-[1000px]  border-b-[6px] border-[1px] border-black p-[60px] gap-[30px] rounded-[45px]  mt-[60px]  max-lg:flex-col max-lg:h-[680px] max-sm:p-[40px] max-sm:h-[730px] ">
            ...
            <div className="w-[60%]  flex flex-col gap-[20px] justify-center max-lg:w-full">
                ...
                <button className="w-full max-sm:hidden h-[50px] max-lg:w-[50%] text-black bg-[rgb(200,253,124)] hover:bg-black   hover:text-white rounded-[15px] font-semibold">Start My Seo Journey</button>
            </div>
            <div className="w-[40%]  flex flex-col h-[307px] items-center gap-[40px] max-lg:hidden max-sm:block max-lg:w-full  ">
                <img src="/Image/ranking.svg" alt="" className="w-[350px] h-[267px] " />
