...
const SuccesStory = () => {
    ...
    return (
        <div className="w-full flex justify-center mt-[60px] ">
                <div className={`max-w-[1240px] w-[90vw] min-h-[540px] max-h-[1520px] max-sm:p-[40px] flex gap-[40px] rounded-[45px] max-lg:flex max-lg:flex-col  p-[60px] bg-black`}>
                    <div className=" w-[45vw] flex flex-col gap-[70px] max-lg:w-full  h-full bg-black ">
                        <div>
