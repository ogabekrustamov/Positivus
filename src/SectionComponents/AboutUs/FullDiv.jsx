...
const FullDiv = () => {
    return (
        <div className="bg-[rgb(207,255,113)] flex  w-[90vw] max-w-[1240px] h-[400px]  border-[1px] border-black p-[70px] gap-[30px] rounded-[45px]  mt-[60px] max-lg:w-[600px] max-lg:flex-col max-lg:h-[680px] max-sm:h-[730px] max-sm:w-[410px]">
            ...
            <div className="w-[60%] flex flex-col gap-[20px] justify-center max-lg:w-full">
                ...
                <button className="w-[200px] h-[50px] text-white bg-black hover:bg-[white] border-[1px] border-black hover:text-black rounded-[15px]">Explore Careers</button>
            </div>
