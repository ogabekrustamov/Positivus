// import aboutill from 'public/Image/aboutill.svg';


const HeroAbout = () => {
    return (
        <div data-aos="fade-up" className=" w-[90vw] max-w-[1240px] h-[606px] bg-[rgb(243,243,243)] flex flex-row items-center p-[70px] justify-center max-sm:h-[600px] max-sm:w-[410px]   max-lg:h-[850px]  max-lg:flex-col-reverse max-lg:w-[650px] rounded-[45px] gap-[60px]">
            <div className="w-[600px] h-[450px] max-sm:w-[310px] max-lg:w-[500px]">
                <img src="/Image/aboutill.svg" alt=""/>
            </div>
