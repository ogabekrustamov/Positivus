    ...
    return (
        <div className=" flex flex-col  justify-center w-[90vw] max-w-[1240px] mx-auto mb-[40px]">
            ...
            <div data-aos="fade-up" className="flex max-lg:justify-center w-full  ">
                <span
                    className=" text-[30px] h-[51px] flex justify-center font-[500] mr-5 max-sm:text-[17px]  max-sm:h-[45px] max-sm:items-center"><h1 className={`bg-[rgb(207,255,113)] rounded-[6px] px-[5pxç]`}>Our Working Process </h1></span>
                <div
