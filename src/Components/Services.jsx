    ...
    return (
        <div>
            <div className="flex max-lg:justify-center max-sm:justify-center">
                <span className="bg-[rgb(207,255,113)] text-[30px] w-[178px] h-[51px] flex justify-center font-[500] mr-5 max-sm:text-[18px] max-sm:w-[90px] max-sm:h-[45px] max-sm:items-center"><h1>Services</h1></span>
                <div className="w-[580px] h-[46px] max-lg:w-[540px] max-sm:w-[370px] max-sm:h-[80px] max-sm:text-[14px]">At our digital marketing agency, we offer a range of services to help businesses grow and succeed online. These services include:</div>
            </div>
            <div className="grid grid-rows-3 grid-cols-2 gap-[40px] pt-[40px] max-lg:flex max-lg:flex-col max-lg:items-center">
                <div className="w-[600px] h-[310px] bg-[rgb(243,243,243)] rounded-[45px]  border-[1px] border-b-6 p-[50px] max-sm:w-[450px] max-sm:h-[240px] max-sm:p-[20px]">
                    ...
                    <div className=" inline-block  " >
                        <img src={serch} className="w-[230px] h-[200px] inline-block float-right ml-[70px] max-sm:w-[200px] max-sm:h-[170px] max-sm:ml-8 max-sm:mb-4" alt=""/>
                    </div>
                </div>

                <div className="w-[600px] h-[310px] bg-[rgb(207,255,113)] rounded-[45px]  border-[1px] border-b-6 p-[50px] max-sm:w-[450px] max-sm:h-[240px] max-sm:p-[20px]">
                    <div className=" inline-block">
                    ...
                    <div className=" inline-block  " >
                        <img src={click} className="w-[230px] h-[200px] inline-block float-right ml-[70px] max-sm:w-[200px] max-sm:h-[170px] max-sm:ml-8 max-sm:mb-4" alt=""/>
                    </div>
                </div>

                <div className="w-[600px] h-[310px] bg-black rounded-[45px]  border-[1px] border-b-6 p-[50px] max-sm:w-[450px] max-sm:h-[240px] max-sm:p-[20px]">
                    <div className=" inline-block">
                    ...
                    <div className=" inline-block  " >
                        <img src={media} className="w-[230px] h-[200px] inline-block float-right ml-[70px] max-sm:w-[200px] max-sm:h-[170px] max-sm:ml-8 max-sm:mb-4" alt=""/>
                    </div>
                </div>
                ...
                <div className="w-[600px] h-[310px] bg-[rgb(243,243,243)] rounded-[45px]  border-[1px] border-b-6 p-[50px] max-sm:w-[450px] max-sm:h-[240px] max-sm:p-[20px]">
                    ...
                    <div className=" inline-block  " >
                        <img src={message} className="w-[230px] h-[200px] inline-block float-right ml-[70px] max-sm:w-[200px] max-sm:h-[170px] max-sm:ml-8 max-sm:mb-4" alt=""/>
                    </div>
                </div>
                ...
                <div className="w-[600px] h-[310px] bg-[rgb(207,255,113)] rounded-[45px]  border-[1px] border-b-6 p-[50px] max-sm:w-[450px] max-sm:h-[240px] max-sm:p-[20px]">
                    ...
                    <div className=" inline-block  " >
                        <img src={content} className="w-[230px] h-[200px] inline-block float-right ml-[70px] max-sm:w-[200px] max-sm:h-[170px] max-sm:ml-8 max-sm:mb-4" alt=""/>
                    </div>
                </div>
                ...
                <div className="w-[600px] h-[310px] bg-black rounded-[45px]  border-[1px] border-b-6 p-[50px] max-sm:w-[450px] max-sm:h-[240px] max-sm:p-[20px]">
                    ...
                    <div className=" inline-block  " >
                        <img src={statistic} className="w-[230px] h-[200px] inline-block float-right ml-[70px] max-sm:w-[200px] max-sm:h-[170px] max-sm:ml-8 max-sm:mb-4" alt=""/>
                    </div>
                </div>

                <div className=" hidden bg-[rgb(243,243,243)] rounded-[45px] mt-[60px] max-lg:w-[600px] max-lg:h-[310px] max-lg:block max-sm:block max-sm:w-[450px] max-sm:h-[240px] max-sm:p-[20px] max-sm:mt-[20px]">
                    <div className="w-[500px]  inline-flex flex-col gap-[30px] justify-center h-full ml-[60px] max-sm:w-[300px] max-sm:gap-[20px]">
