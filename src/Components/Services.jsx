    ...
    return (
        <div className=" w-[90vw] max-w-[1240px] mx-auto  h-[1700px] max-lg:h-[2650px] max-sm:h-[2020px]">
            ...
            <div  className="   grid grid-rows-3 grid-cols-2 gap-[40px] pt-[40px] max-lg:flex max-lg:flex-col max-lg:items-center ">
                <div data-aos="fade-up" className="  w-full max-h-[310px] flex gap-[5vw] bg-[rgb(243,243,243)] rounded-[45px]  border-[1px] justify-between border-b-6 p-[50px]  max-sm:h-[220px] max-sm:p-[20px] max-sm:rounded-[30px] transition-all ease-in-out duration-300 hover:scale-105 ">
                ...
                <div data-aos="fade-up" className="w-full h-[310px] flex gap-[5vw] bg-[rgb(207,255,113)] rounded-[45px]  border-[1px] border-b-6 p-[50px]    max-sm:h-[220px] max-sm:p-[20px] max-sm:rounded-[30px] transition-all ease-in-out duration-300 hover:scale-105">
                    <div className=" w-[400px] ">
                ...
                <div data-aos="fade-up" className="w-full h-[310px] flex gap-[4vw] bg-[rgb(243,243,243)] rounded-[45px]  border-[1px] border-b-6 p-[50px]  max-sm:h-[220px] max-sm:p-[20px] max-sm:rounded-[30px] transition-all ease-in-out duration-300 hover:scale-105">
                    <div className=" w-[400px]">
                ...
                <div data-aos="fade-up" className="w-full flex gap-[5vw] h-[310px] bg-[rgb(207,255,113)] rounded-[45px]  border-[1px] border-b-6 p-[50px]  max-sm:h-[220px] max-sm:p-[20px] max-sm:rounded-[30px]  hover:scale-105 transform transition-transform ease-in-out duration-300">
                    <div className=" w-[400px]">
                ...
                <div data-aos="fade-up" className=" hidden bg-[rgb(243,243,243)] rounded-[45px] mt-[60px] w-full max-lg:h-[310px] max-lg:block  max-sm:h-[220px] max-sm:p-[20px] max-sm:mt-[20px] max-sm:rounded-[30px]">
